...
This document records the **Ubuntu-adapted** manual testing steps for the WMS project,
including **what each step is doing** and **why it matters**.
...
- A new file appears under:
  `src/dev/backend/alembic/versions/`
- Command exits without errors.

### Cleanup note

If this migration was created only to validate tooling (and contains no real schema changes),
