...
## Purpose
This document defines the standard development environment setup and daily workflow for the Warehouse Management System (WMS).
It serves as the long-term reference for onboarding, maintenance, and troubleshooting of local development environments.
