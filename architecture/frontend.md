...
This document describes the frontend architecture of the Warehouse
Management System (WMS).

It defines the structure, responsibilities, development workflow, and
integration strategy of the frontend application.
...
src/dev/frontend/ ├── src/ │ ├── components/ │ ├── pages/ │ ├──
services/ │ ├── hooks/ │ ├── styles/ │ └── main.ts / main.js ├── public/
...
GET /health POST /orders GET /inventory
